...
def read_and_analyze_data():
    ...
    return revenue_by_product, top_product, top_region, top_month, total_revenue, region_revenue, month_revenue

def print_report(revenue_by_product, top_product, top_region, top_month, total_revenue, region_revenue, month_revenue):
...
def main():
    generate_sales_data()
    revenue_by_product, top_product, top_region, top_month, total_revenue, region_revenue, month_revenue = read_and_analyze_data()
    print_report(revenue_by_product, top_product, top_region, top_month, total_revenue, region_revenue, month_revenue)
